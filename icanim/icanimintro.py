...
def main():
    ...
    a.sleep(2)
    a.replace_text('cap1','The distance between the lowest-energy occupied band (valence band) and the')
    a.add_fade_text('cap2','highest-energy unoccupied band (conduction band) is the band gap.',x=20,y=34)
